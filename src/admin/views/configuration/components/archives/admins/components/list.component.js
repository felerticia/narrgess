...
// actions
import { getAdminsArchives, getAdminArchives, getUserArchives } from '../../../../../../../actions/get.action';
import { editAdmin, editUser } from '../../../../../../../actions/edit.action';
import { deleteAdminArchive, deleteUserArchive } from '../../../../../../../actions/delete.action';
...
class List extends Component {
    ...
    UNSAFE_componentWillMount() {
        getAdminsArchives().then(data => this.setState({ data, loading: false }));
    }
    ...
    handleUnarchive(id) {
        ...
        getAdminArchives(id).then(admin => {
            getUserArchives(id).then(user => {
                editAdmin(id, admin).then(() => {
                    editUser(id, user).then(() => {
                        deleteAdminArchive(id).then(() => {
