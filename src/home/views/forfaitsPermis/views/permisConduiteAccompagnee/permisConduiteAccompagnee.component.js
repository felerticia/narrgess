...
class PermisConduiteAccompagnee extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            ...
            >
                <Segment inverted color="blue" padded="very" style={Style.segmentTop}>
                    <Header as="h4" content="CONDUITE ACCOMPAGNÉE" />
                    <Header as="h2">
                        330€ <sub>x4</sub>
...
PermisConduiteAccompagnee.propTypes = {
    history: PropTypes.object,
};

export default withRouter(PermisConduiteAccompagnee);